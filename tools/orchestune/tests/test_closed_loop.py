...
from src.dispatch_state import RunState, save_run_state
from src.dispatch_targets import DispatchHandle, DispatchTarget
...
def test_closed_loop_flow():
    ...
    patches = [
        patch("src.github.list_issues_by_label", dummy_github.list_issues_by_label),
        ...
        patch("src.github.list_remote_branches", dummy_github.list_remote_branches),
        patch("src.github.branch_changed_files", dummy_github.branch_changed_files),
    ]
