...
from src.dispatch_rebase import notify_force_serial, notify_recompute
...
class TestNotifyRecompute:
    def test_dry_run_reports_without_calling_github(self):
        ...
        with (
            patch("src.dispatch_rebase.github.add_comment") as mock_comment,
            patch("src.dispatch_rebase.github.add_label") as mock_label,
        ):
...
class TestNotifyForceSerial:
    ...
    def test_dry_run_does_not_call_github(self):
        with patch("src.dispatch_rebase.github.add_comment") as mock_comment:
